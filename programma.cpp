...
{
    int a = stoi(cerca("stipendio.txt", cod));         // richiamo il procedimento della funzione che calcola lo stipendio dalla matricola
    int b = stoi(cerca("straordinari.txt", cod)) * 35; // richiamo il procedimento della funzione che calcola gli straordinari dalla matricola e lo moltiplico per 35 per avere le ore tradotte in soldi
    int c = a + b;                                     // dopo avere trasformato in intero i risultati li posso sommare per avere il calcolo totale del guadagno (stipendio con straordinari)
    cout << "matricola: " << cod << " il guadagno totale e' " << c << endl;
}
